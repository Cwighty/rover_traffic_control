...
internal class ProblemDetailException : Exception
{
    ...
    public ProblemDetailException(string message) : base(message)
    {
    }

    public ProblemDetailException(string message, Exception innerException) : base(message, innerException)
    {
    }
